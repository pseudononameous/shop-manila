    ...
    <div class="main" ng-controller="InvoiceListCtrl">
        ...
        <div class="admin-content">
            ...
            <div ng-controller="SearchCtrl">
                ...
                <form name="searchForm" class="form-horizontal" ng-submit="searchForm.$valid && search('created_at', 'admin/search/invoices')">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <div class="search-btn">
                                    ...
                                    <a class="btn btn-default" href="{{route('admin.invoices.index')}}">Clear</a>
                                </div>
                            </div>
                        </div>
