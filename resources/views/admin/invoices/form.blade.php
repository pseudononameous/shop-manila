...
<div class="container">
    <div class="main" ng-controller="{{$ctrl}}">
        ...
        <form class="form-horizontal" name="invoiceForm" role="form" ng-submit="invoiceForm.$valid && save()">
            ...
            <my-form-buttons is-invalid="invoiceForm.$invalid" return-to="{{route('admin.invoices.index')}}"></my-form-buttons>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr ng-repeat="or in data.orderDetails">
                            ...
                            <td>
                                <input type="text" class="form-control" ng-model="data.invoiceDetails.qtyToInvoice[or.id]" my-not-more-than-value="@{{or.qty}}" required>
                            </td>
                            <td>
