                    ...
                    <fieldset class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div ng-repeat="c in options.categories">
                                <div class="checkbox" ng-if="$index >=9 && $index <= 11 || $index==0">
                                    <label ng-if="$index != 0">
                                        <input type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>

                                    <label ng-if="$index == 0" style="background-color: black;padding: 5px 15px 5px 10px;color: white;text-transform: uppercase;font-weight: bold;margin-left: 20px;display: block; margin-right: 30px;">
                                        <input style="margin-left: -30px;" type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>
                        ...
                        <div class="col-md-4">
                            <div ng-repeat="c in options.categories">
                                <div class="checkbox" ng-if="$index >=12 && $index <= 14 || $index==1">
                                    <label ng-if="$index !=1">
                                        <input type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>

                                    <label ng-if="$index == 1" style="background-color: black;padding: 5px 15px 5px 10px;color: white;text-transform: uppercase;font-weight: bold;margin-left: 20px;display: block; margin-right: 30px;">
                                        <input style="margin-left: -30px;" type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>
                        ...
                        <div class="col-md-4">
                            <div ng-repeat="c in options.categories">
                                <div class="checkbox" ng-if="$index >=15 && $index <= 17 || $index==2">
                                    <label ng-if="$index != 2">
                                        <input type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>

                                    <label ng-if="$index == 2" style="background-color: black;padding: 5px 15px 5px 10px;color: white;text-transform: uppercase;font-weight: bold;margin-left: 20px;display: block; margin-right: 30px;">
                                        <input style="margin-left: -30px;" type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>
                        ...
                        <div class="col-md-4">
                            <div ng-repeat="c in options.categories">
                                <div class="checkbox" ng-if="$index >=18 && $index <= 25 || $index==3">
                                    <label ng-if="$index != 3">
                                        <input type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>

                                    <label ng-if="$index == 3" style="background-color: black;padding: 5px 15px 5px 10px;color: white;text-transform: uppercase;font-weight: bold;margin-left: 20px;display: block; margin-right: 30px;">
                                        <input style="margin-left: -30px;" type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>
                        ...
                        <div class="col-md-4">
                            <div ng-repeat="c in options.categories">
                                <div class="checkbox" ng-if="$index >=26 && $index <= 32 || $index==4">
                                    <label ng-if="$index !=4">
                                        <input type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>

                                    <label ng-if="$index == 4" style="background-color: black;padding: 5px 15px 5px 10px;color: white;text-transform: uppercase;font-weight: bold;margin-left: 20px;display: block; margin-right: 30px;">
                                        <input style="margin-left: -30px;" type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div ng-repeat="c in options.categories">
                                <div class="checkbox" ng-if="$index >=33 && $index <= 35 || $index==5">
                                    <label ng-if="$index != 5">
                                        <input type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>

                                    <label ng-if="$index == 5" style="background-color: black;padding: 5px 15px 5px 10px;color: white;text-transform: uppercase;font-weight: bold;margin-left: 20px;display: block; margin-right: 30px;">
                                        <input style="margin-left: -30px;" type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>
                        ...
                        <div class="col-md-4">
                            <div ng-repeat="c in options.categories">
                                <div class="checkbox" ng-if="$index >=36 && $index <= 38 || $index==6">
                                    <label ng-if="$index != 6 ">
                                        <input type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>

                                    <label ng-if="$index == 6" style="background-color: black;padding: 5px 15px 5px 10px;color: white;text-transform: uppercase;font-weight: bold;margin-left: 20px;display: block; margin-right: 30px;">
                                        <input style="margin-left: -30px;" type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>
                        ...
                        <div class="col-md-4">
                            <div ng-repeat="c in options.categories">
                                <div class="checkbox" ng-if="$index >=39 && $index <= 42 || $index==7">
                                    <label ng-if="$index != 7">
                                        <input type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>

                                    <label ng-if="$index == 7" style="background-color: black;padding: 5px 15px 5px 10px;color: white;text-transform: uppercase;font-weight: bold;margin-left: 20px;display: block; margin-right: 30px;">
                                        <input style="margin-left: -30px;" type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>
                        ...
                        <div class="col-md-4">
                            <div ng-repeat="c in options.categories">
                                <div class="checkbox" ng-if="$index >=43 && $index <= 48 || $index==8">
                                    <label ng-if="$index != 8">
                                        <input type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>

                                    <label ng-if="$index == 8" style="background-color: black;padding: 5px 15px 5px 10px;color: white;text-transform: uppercase;font-weight: bold;margin-left: 20px;display: block; margin-right: 30px;">
                                        <input style="margin-left: -30px;" type="checkbox" ng-model="c.selected" ng-checked="c.selected"> @{{c.name}}
                                    </label>
