...
class ItemMerchantController extends BaseController {
	...
	public function index()
	{
		...
		Assets::add([
			...
			URL::asset('js/itemMerchant/ItemListCtrl.js'),
			URL::asset('js/itemMerchant/ItemSrvc.js'),
		]);
		...
		return view('admin.itemsMerchant.list', compact('data', 'item', 'store', 'hasImage', 'status'));
	...
	public function create()
	{
		...
		Assets::add([
			URL::asset('js/itemMerchant/AddItemCtrl.js'),
			URL::asset('js/itemMerchant/ItemSrvc.js'),
		...
		return view('admin.itemsMerchant.form', compact('ctrl', 'title', 'userStoreId'));
	}
	...
	{
		Assets::add([
			URL::asset('js/itemMerchant/EditItemCtrl.js'),
			URL::asset('js/itemMerchant/ItemSrvc.js'),
			URL::asset('js/store/StoreSrvc.js'),
			URL::asset('js/tags/TagSrvc.js'),
			URL::asset('js/event/EventSrvc.js'),
	...
	public function search(Request $request)
	{
		...
		return view('admin.itemsMerchant.list', compact('data', 'item', 'hasImage', 'status'));
